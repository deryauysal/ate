...
// Version: 12/27/2022
// 
//Moment functions for the  ipw1 estimator in Uysal (2022)
//Input: 
// Data & specifications
//     struct DS ds_struct;
//     ds_struct = dsCreate;
...
proc ipw1_mom(struct PV p, struct DS ds_struct); 
...
local alp, mu1, mu0, k, psi1,psi2,psi3, psest, dpsest;
...
psi2=meanc((treat./psest).*dep)-mu1;
psi3=meanc(((1-treat)./(1-psest)).*dep)-mu0;
